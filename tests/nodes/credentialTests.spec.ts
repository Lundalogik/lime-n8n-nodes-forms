import { limeCrmApiTest, limeFormsApiTest } from '../../nodes/credentialTests';

describe.each([
	['limeCrmApiTest', limeCrmApiTest, '/api/v1/'],
	['limeFormsApiTest', limeFormsApiTest, '/api/v1/external-integrations/ping'],
])('%s', (_name, credentialTest, pingPath) => {

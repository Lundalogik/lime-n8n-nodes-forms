import { LimeCrmApi } from '../../credentials/LimeCrmApi.credentials';
import { LimeFormsApi } from '../../credentials/LimeFormsApi.credentials';

describe.each([
	['LimeCrmApi', new LimeCrmApi()],
	['LimeFormsApi', new LimeFormsApi()],
])('%s credential webhook secret field', (_name, credential) => {
